"""Base class for push notification providers — no Home Assistant dependency."""
...
class PushProvider(ABC):
    ...
    def __init__(self, session: "aiohttp.ClientSession") -> None:
        """Initialize the provider with an aiohttp session."""
    ...
    async def async_send_to_many(
        ...
        """Send a notification to multiple devices sequentially."""
        results = []
